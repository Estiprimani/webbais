...
<body>
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="#">
                <p class="text-muted" style="height: 20px;"> Login WEBBAIS</p>
            </a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class=" login-box-msg text-muted text-center" id="header-panel">WEBBAIS System</p>
                ...
                <label>
                  <input type="checkbox"> Remember Me
                    ...
                    <div class="col-xs-12">
                        ...
                        <a href="{{ url('/') }}" class="btn btn-danger btn-block btn-flat">Home</a>
